...
4. 使用脚本批量获取真空能级
   ...
   ![](/img/lvthw/ex52/ex52-4.png)

   1. 批量生成 LOCPOT_Z 文件：

      ![](/img/lvthw/ex52/ex52-5.png)

   2. 使用脚本批量读取

      ![](/img/lvthw/ex52/ex52-6.png)

5. 批量获得费米能级：

   ![](/img/lvthw/ex52/ex52-7.png)
...
![](/img/lvthw/ex52/ex52-8.png)

真空能级，费米能级以及功函数随真空层厚度的变化

![](/img/lvthw/ex52/ex52-9.png)

图中的测试曲线看起来很漂亮，但纵坐标范围太大，我们将功函数随真空层的变化作图如下：

![](/img/lvthw/ex52/ex52-10.png)
