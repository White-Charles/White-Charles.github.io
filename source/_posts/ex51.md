...
![](/img/lvthw/ex51/ex51-2.jpeg)

设置 `LVHAR = .TRUE.` 的结果如下：

![](/img/lvthw/ex51/ex51-3.jpeg)

我们对比下 13-15 $\AA$范围内纵坐标的大小和平均值

![](/img/lvthw/ex51/ex51-4.png)
...
![](/img/lvthw/ex51/ex51-5.jpeg)

![](/img/lvthw/ex51/ex51-6.png)

**注意：**

在 Hand-on-session (**老版本**的官方教程)中，使用的是 LVTOT 这个参数。老版本就是过时的意思。希望大家的以新版本的计算为准。

![](/img/lvthw/ex51/ex51-7.png)
...
![](/img/lvthw/ex51/ex51-9.png)

结构如下图：

![](/img/lvthw/ex51/ex51-10.png)

我们发现 slab 的 Cu 原子部分之间好像也被拉长了。测量了一下两个 Cu 原子之间的距离为： 2.956 Å。

![](/img/lvthw/ex51/ex51-11.png)

修改之前为： 2.547 Å。

![](/img/lvthw/ex51/ex51-12.png)
