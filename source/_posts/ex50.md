...
1.  点击 scripts
   ...
   ![](/img/lvthw/ex50/ex50-9.png)

2. 鼠标右击这个脚本

   ![](/img/lvthw/ex50/ex50-10.png)

3. 另存为，然后选择保存的目录

   ![](/img/lvthw/ex50/ex50-11.png)

4. 这里本人保存到电脑桌面上了

   ![](/img/lvthw/ex50/ex50-12.png)

**注意：**

如果你运行脚本的时候，没有得到下面图中的这个结果：

![](/img/lvthw/ex50/ex50-13.jpeg)

原因可能在与：

![](/img/lvthw/ex50/ex50-14.png)
