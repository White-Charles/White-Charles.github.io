...
![](/img/lvthw/ex19/ex19-1.jpeg)
重复之前KPOINTS的批处理操作，我们可以获得一系列不同大小格子的文件夹。如下图：
![](/img/lvthw/ex19/ex19-2.jpeg)
...
### 2 测试结果分析
### 2.1 模型大小对计算时间的影响
![](/img/lvthw/ex19/ex19-3.jpeg)

注意：在后面加入 `sort –n` 后输出的变化。

---

![](/img/lvthw/ex19/ex19-4.jpeg)

![](/img/lvthw/ex19/ex19-5.jpeg)
