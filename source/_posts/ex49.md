...
3. 打开 p4vasp 并导入 LOCPOT 文件：file --> loadsystem，然后找到 LOCPOT 所在的目录，点解导入，效果如下
   ...
   ![](/img/lvthw/ex49/ex49-2.png)

#### 4.2 开始可视化 (Linux, Windows 都一样了)

Electronic –> Local potential

![](/img/lvthw/ex49/ex49-3.png)

效果如下：

![](/img/lvthw/ex49/ex49-4.jpeg)
...
![](/img/lvthw/ex49/ex49-5.png)

效果如下：

![](/img/lvthw/ex49/ex49-6.png)
...
![](/img/lvthw/ex49/ex49-9.png)

![](/img/lvthw/ex49/ex49-10.png)

这三部分的顺序，如下图，

![](/img/lvthw/ex49/ex49-11.png)

我们从图中可以看出，基本上在 10-18 的这个区间范围，三条线的数据差不多是一样的。静电势能的话，可以通过红线( Average 那条线)，也就是第二部分来获取。可以查看下 14-15 $\AA$ 时红色曲线的数值，如下图：

![](/img/lvthw/ex49/ex49-12.png)

#### 4.5 获取费米能级

![](/img/lvthw/ex49/ex49-13.png)

套公式，功函数为： 4.84-0.03 = 4.81 eV

对比下维基百科中的数值：

![](/img/lvthw/ex49/ex49-14.png)
